<?php
// debug_sendemail.php - Fixed version
...
// These use statements MUST be here, at the top level
...
try {
    ...
    if (!$brevo_key) {
        echo "<p style='color: red;'>❌ Environment variable not set! Check Render dashboard.</p>";
    } else {
